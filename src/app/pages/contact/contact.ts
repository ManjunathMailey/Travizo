...
export class ContactComponent {
  ...
  constructor(private fb: FormBuilder, private sanitizer: DomSanitizer, private notify: NotificationService) {
  ...
  onSubmit() {
    ...
    if (this.contactForm.valid) {
      this.submitted = true;
      this.notify.success('Message sent! We\'ll get back to you within 24 hours. ✉️');
    }
  }
